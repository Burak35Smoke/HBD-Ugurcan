  ...
  return (
    <section ref={sectionRef} className="bg-gradient-to-b from-blue-900 to-black min-h-screen py-16 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-white mb-12">Dinledikçe beni hatırla..</h2>
        ...
        <div className="mt-24">
          <h2 className="text-3xl font-bold text-center text-white mb-8">Bu not da benden :)</h2>
          <MyAudio />
        </div>
      </div>
    </section>
